...
class Coches:
    ...
    #El encapsulamiento en Python también es llamado "visibilidad", y prácticamente se puede hacer que un atributo y/o método sean públicos o privados.
    ...
    #Nota 1: para utilizar un atributo privado, es necesario hacerlo a través de un método público
    ...
    #Nota 2: para utilziar un método privado, es necesario hacerlo dentro de un método público
...
class Camionetas(Coches):
   ...
   def transportar(self, numero_pasajeros):
      self.numero_pasajeros = numero_pasajeros
      return self.numero_pasajeros
